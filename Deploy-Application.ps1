...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		##Copy-File -Path "$dirSupportFiles\setup.iss" -Destination "C:\Windows\setup.iss"
		...
		$exitCode = Execute-Process -Path "SureTrend40.exe" -Parameters "/s /f1`"$dirSupportFiles\setup.iss`"" -WindowStyle "Hidden" -PassThru
